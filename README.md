...
This image runs [Chef Server 12](https://downloads.getchef.com/chef-server/) 12.17.33 on Ubuntu 16.04. Bundled with Chef Client 14.0.202.

A docker image running Chef 12 published. Run via:

    $  docker-compose up

## Prerequisites

The `kernel.shmmax` and `kernel.shmall` sysctl values should be set to a high value on the host. Consider a command such as:
...
The docker-compose.yml file maps these to 3080:80, 3081:443 and 8443:443.
